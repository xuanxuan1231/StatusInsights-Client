...
/// Returns the window handle for the given Flutter view ID.
static constexpr int64_t kFlutterViewId = 0LL;

constexpr const wchar_t kWindowClassName[] = L"FLUTTER_RUNNER_WIN32_WINDOW";

/// Registry of active Win32Window instances.
static std::map<HWND, Win32Window*> g_window_map;
